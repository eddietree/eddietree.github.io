function DebugGrid()
{
	this.initGrid = function()
	{
		...
		for ( var i = 0; i < segments; i ++ ) {
			...
			// colors
			colors[ i * stride + 0 ] = 1.0;
			colors[ i * stride + 1 ] = 1.0;
			colors[ i * stride + 2 ] = 1.0;
			colors[ i * stride + 3 ] = 1.0;
			colors[ i * stride + 4 ] = 1.0;
			colors[ i * stride + 5 ] = 1.0;
			colors[ i * stride + 6 ] = 1.0;
			colors[ i * stride + 7 ] = 1.0;
			colors[ i * stride + 8 ] = 1.0;
			colors[ i * stride + 9 ] = 1.0;
			colors[ i * stride + 10] = 1.0;
			colors[ i * stride + 11] = 1.0;
		}
